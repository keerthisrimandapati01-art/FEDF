...
import { CountdownTimer } from "@/components/skyline/CountdownTimer";
import { useBooking } from "@/store/booking";
import { Bell, DoorOpen, Plane, AlertTriangle, CheckCircle2, Coffee } from "lucide-react";
...
function Notifications() {
  ...
  const boardingTarget = new Date(); boardingTarget.setHours(boardingTarget.getHours() + 9);
